...
if("FALSE" STREQUAL "TRUE")
  set(eigen_conversions_SOURCE_PREFIX /home/sid/catkin_ws/src/geometry/eigen_conversions)
  set(eigen_conversions_DEVEL_PREFIX /home/sid/catkin_ws/devel)
  ...
  set(eigen_conversions_INSTALL_PREFIX /home/sid/catkin_ws/install)
...
if(NOT "include;/usr/include/eigen3;/opt/ros/kinetic/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'eigen_conversions' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/sid/catkin_ws/install/${idir}'.  ${_report}")
    endif()
