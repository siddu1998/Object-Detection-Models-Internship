...
if("FALSE" STREQUAL "TRUE")
  set(tf_SOURCE_PREFIX /home/sid/catkin_ws/src/geometry/tf)
  set(tf_DEVEL_PREFIX /home/sid/catkin_ws/devel)
  set(tf_INSTALL_PREFIX "")
  set(tf_PREFIX ${tf_DEVEL_PREFIX})
else()
  set(tf_SOURCE_PREFIX "")
  set(tf_DEVEL_PREFIX "")
  set(tf_INSTALL_PREFIX /home/sid/catkin_ws/install)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'tf' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/sid/catkin_ws/install/${idir}'.  ${_report}")
    endif()
