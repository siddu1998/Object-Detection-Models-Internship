...
if("FALSE" STREQUAL "TRUE")
  set(urdf_SOURCE_PREFIX /home/sid/catkin_ws/src/robot_model/urdf)
  set(urdf_DEVEL_PREFIX /home/sid/catkin_ws/devel)
  set(urdf_INSTALL_PREFIX "")
  set(urdf_PREFIX ${urdf_DEVEL_PREFIX})
else()
  set(urdf_SOURCE_PREFIX "")
  set(urdf_DEVEL_PREFIX "")
  set(urdf_INSTALL_PREFIX /home/sid/catkin_ws/install)
...
if(NOT "include;/usr/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'urdf' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/sid/catkin_ws/install/${idir}'.  ${_report}")
    endif()
